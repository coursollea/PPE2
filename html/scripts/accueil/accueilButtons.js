$('#connectionLink').on('click', function(){
	...
	'<div class = "filterDiv">'+
		'<form class = "connectionDiv" methode = "GET" action = "../redirect/portail.php">'+
			...
			'<input type = "text" id="connexion" name = "username" class = "form-inputtext" placeholder = "Nom de compte" required><br/>'+
			'<input type = "password" id="password"  name = "password" class = "form-inputtext" placeholder = "Mot de passe" required><br/>'+
